...
| Name | Value | Role |
|------|-------|------|
| Forest Green | `#0f3e17` | Primary brand color for calls to action, text, and critical icons — grounding the UI with a sense of growth and reliability |
| Cream Canvas | `#fffefc` | Background for page surfaces and pristine component backdrops, providing a clean, bright foundation |
| Mint Glaze | `#b1dbb8` | Soft background for informational cards and sections, introducing a gentle, almost pastel tint to the UI planes |
| Slate Mist | `#b6ced5` | Cool, muted background for secondary cards and sections, offering visual separation without overwhelming the primary content |
| Keylime Wash | `#e1f4df` | Lightest green surface, used for subtle card backgrounds or layered elements, providing a hint of color |
| Mint Kiss | `#cfe7d3` | Another very light green surface, subtly differentiating stacked cards or sections |
| Border Grey | `#e5e7eb` | Default boundary and separator color, used for hairline borders and inactive states, maintaining visual separation with minimal distraction |
| Ink Text | `#222222` | Primary text color for navigation and core content, providing strong contrast against light backgrounds |
| Dark Charcoal | `#333333` | Secondary text and link color for less prominent information, like image captions or muted links |

## Typography

### Suisseintl — The workhorse sans-serif for most body text, links, buttons, and detailed interface elements. Its refined simplicity supports a clinical tone without feeling sterile.
- **Substitute:** Inter
- **Weights:** 300, 400
...
### Faire Octave — Used exclusively for large, impactful headings. Its light weight (300) for such prominent sizes creates an authoritative yet approachable voice, suggesting wisdom through understatement rather than volume.
...
| body | 14px | 1.5 | -0.42px |
| body-lg | 18px | 1.5 | -0.54px |
| subheading | 23px | 1.3 | -0.69px |
| heading-sm | 28px | 1.3 | -0.84px |
| heading | 40px | 1.05 | -0.4px |
| display | 56px | 1 | -1.68px |
| display-lg | 74px | 1.05 | -0.74px |
